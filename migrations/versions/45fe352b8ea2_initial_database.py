...
Revision ID: 45fe352b8ea2
Revises: 
Create Date: 2024-12-22 14:23:33.275005
...
def upgrade() -> None:
    ...
    op.create_table('month_essential_expense',
    sa.Column('id_month_fk', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['id_month_fk'], ['month.id'], ),
    sa.PrimaryKeyConstraint('id_essential_expense_fk')
    )
    op.create_table('month_income',
    sa.Column('id_month_fk', sa.Integer(), nullable=False),
    sa.Column('id_income_fk', sa.Integer(), nullable=False),
    sa.Column('amount', sa.DECIMAL(precision=10, scale=2), nullable=False),
    sa.ForeignKeyConstraint(['id_income_fk'], ['income.id'], ),
    sa.ForeignKeyConstraint(['id_month_fk'], ['month.id'], ),
    sa.PrimaryKeyConstraint('id_income_fk')
    )
    op.create_table('month_non_essential_expense',
    sa.Column('id_month_fk', sa.Integer(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id_non_essential_expense_fk')
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('month_non_essential_expense')
    op.drop_table('month_income')
    op.drop_table('month_essential_expense')
